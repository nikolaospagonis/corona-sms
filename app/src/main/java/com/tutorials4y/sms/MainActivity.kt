...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        r1.setText("1. Φαρμακείο, Γιατρός ")
        r2.setText("2. Είδη πρώτης ανάγκης")
        r3.setText("3. Τράπεζες")
        r4.setText("4. Βοήθεια σε ανθρώπους με ανάγκη")
        r5.setText("5. Τελετές, παιδιά διαζευμένων γονέων")
        r6.setText("6. Σωματική άσκηση.")
